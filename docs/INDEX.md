...
| `docs/reproducibility_contract_v1.md` | gates-2026-08 | Computational-vs-data reproducibility (decision 63): synthetic full-pipeline demo + Dockerfile for third parties; custodian route for licensed numbers; Windows-path residual policy. |
| `docs/sequential_multiplicity_policy_v1.md` | gates-2026-08 | Sequential multiplicity (decision 64): alpha spending 0.05/(k(k+1)) over future campaigns, e-values/martingale/always-valid p, max 3 further confirmatory campaigns; retrospective results stay exploratory. |
| `STATUS.md` (root) | gates-2026-08 | AUTO-GENERATED canonical state (decision 63); CI fails on drift; supersedes any narrative document that disagrees. |
| `execution_backlog_20260817.md` | gates-2026-08 | Source of truth for the gate cascade: definition of done, honesty and decision-52 governance rules, strict gate ordering with Gate 5 running in the background. | *(internal working record — kept local, not part of the public mirror)*
...
| `docs/project_knowledge_system.md` | infrastructure | Evergreen reference for the repo-local GBrain/Graphify knowledge system, its isolation contract and the 15-minute auto-sync task. | *(internal working record — kept local, not part of the public mirror)*
...
| `timing_sensitivity_execution_plan_v1.md` | provider-timing | READY_TO_EXECUTE local-compute plan (R-023) to rerun C4/C5 under the registered 120s/300s UW created_at sensitivities without overwriting frozen 60s artifacts. | *(internal working record — kept local, not part of the public mirror)*
...
| `consolidation_record_20260817.md` | governance | Audit record of the 2026-08-17 repository consolidation: backups, archive branch, fast-forward to main, evidence-root materialization and EOL pinning. | *(internal working record — kept local, not part of the public mirror)*
| `repository_hygiene_decision_v1.md` | governance | Pre-consolidation hygiene gate record (inventory, secret scan, reproducibility manifest, deferred checkpoint, status PARTIAL); overtaken by the 2026-08-17 repository consolidation. | *(internal working record — kept local, not part of the public mirror)*
| `supervisor_request_pack_v1.md` | governance | Request pack tracking pending human decisions D001-D004 with ready-to-send supervisor email drafts (assessment template, metadata, framing sign-off), 2026-08-17. | *(internal working record — kept local, not part of the public mirror)*
...
| `week4_evidence_recovery.md` | recovery-week4 | Week-4 evidence recovery plan (Spanish) from the early RESEARCH_ONLY state with B1 blocked and backfill unauthorized; kept as an audit-trail record of past process. | *(internal working record — kept local, not part of the public mirror)*
