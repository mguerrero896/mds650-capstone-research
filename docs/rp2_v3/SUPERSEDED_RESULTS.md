...
| `artifacts/rp2_block6_flow/flow_coverage.json` (`d7320a54…`) and the B2 panel | `fix/rp2-v3-exact-clock-b2` | economics measured on the availability clock, a one-day floor on time to expiry, and no 0DTE features | 2026-08-20 |
