...
EVIDENCE = {
    ...
    "LIT-008": {
        "full_text_status": "VERIFIED_ABSTRACT_ONLY",
        "claim_strength_allowed": "LIMITED_ABSTRACT",
        "evidence_location": "Wiley publisher record",
        "page": "not_available",
        "section": "abstract/metadata",
        "table_or_figure": "not_available",
        "verification_notes": "The record supports the coherent-HAR and QLIKE/MSE design; the 99/87-percent figures in the matrix are not accepted without the full text table.",
    },
    "LIT-009": {
        "full_text_status": "VERIFIED_PUBLISHER_METADATA_ONLY",
        "claim_strength_allowed": "METADATA_ONLY",
