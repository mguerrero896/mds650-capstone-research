    ...
    return pl.DataFrame(
        {
            ...
            "b2_unique_contract_share": 0.2,
            "b2_log_mean_trade_premium": 1.0,
            "b2_log_max_trade_premium": 1.5,
            "b2_call_put_premium_imbalance_scaled": 0.0,
            "b2_execution_side_premium_imbalance": 0.0,
            "b2_repeated_contract_premium_share": 0.1,
            "b2_strike_concentration": 0.1,
            "b2_expiry_concentration": 0.1,
            "rv30": 0.0003 + x / 1_000_000,
        }
    )
